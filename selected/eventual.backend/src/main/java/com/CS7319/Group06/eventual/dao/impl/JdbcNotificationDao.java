...
public class JdbcNotificationDao implements NotificationDao {
    ...
    public Notification createNotification(Notification notification) {
        String sql = """
                ...
                """;
        try {
            Integer id = jdbcTemplate.queryForObject(sql, Integer.class, notification.getRecipientEmail(), notification.getType().name(), notification.getTitle(), notification.getMessage(), notification.getReferenceId(), notification.getReferenceType() != null ? notification.getReferenceType().name() : null);
            return getById(id);
