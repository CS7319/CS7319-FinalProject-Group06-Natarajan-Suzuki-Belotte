package com.CS7319.Group06.eventual.searchservice.dao.impl;
...
import com.CS7319.Group06.eventual.searchservice.config.ElasticsearchConfig;
...
@Slf4j
@Repository
public class ElasticSearchDao extends AbstractSearchDao implements SearchDao {
     ...
     * - match_phrase on the primary field with x10 boost — exact matches always win
